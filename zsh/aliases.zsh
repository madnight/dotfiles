...
alias aichatn="command aichat --no-highlight"
...
alias aiwiki="command aichat -r wiki"
...
alias cloudrunlogs="gcloud logging read \"resource.type=\\\"cloud_run_revision\\\" timestamp>=\\\"$(date -u -d '24 hours ago' +%Y-%m-%dT%H:%M:%S.%3NZ)\\\"\""
