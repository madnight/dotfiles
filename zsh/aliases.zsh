...
alias dockerdeleteeverthingforce='docker stop $(docker ps -a -q); sudo rm -rf /var/lib/docker/overlay2; docker rmi $(docker images -q); docker system prune'
alias dockerprune='sudo docker system prune -a -f'
alias e='extract'
...
alias vpntwo='sudo openvpn --config /etc/openvpn/two'
